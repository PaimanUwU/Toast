...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2024 at 08:57 AM
...
INSERT INTO `post` (`Post_ID`, `Post_Title`, `Post_Desc`, `Post_Content`, `Post_Likes`, `Post_Dislikes`, `Post_Image_ID`, `Profile_ID`) VALUES
(1, 'Post Title 1', 'Recipe description for post 1', 'Post content for post 1', 21, 0, '1', 1),
(2, 'Post Title 2', 'Recipe description for post 2', 'Post content for post 2', 16, 0, '1', 1),
(3, 'Post Title 3', 'Recipe description for post 3', 'Post content for post 3', 30, 0, '1', 1),
(4, 'Post Title 4', 'Recipe description for post 4', 'Post content for post 4', 10, 0, '1', 1),
(5, 'Post Title 5', 'Recipe description for post 5', 'Post content for post 5', 25, 0, '1', 1),
(6, 'Post Title 6', 'Recipe description for post 6', 'Post content for post 6', 19, 0, '1', 2),
(7, 'Post Title 7', 'Recipe description for post 7', 'Post content for post 7', 22, 0, '1', 2),
(8, 'Post Title 8', 'Recipe description for post 8', 'Post content for post 8', 27, 0, '1', 2),
(9, 'Post Title 9', 'Recipe description for post 9', 'Post content for post 9', 35, 0, '1', 2),
(10, 'Post Title 10', 'Recipe description for post 10', 'Post content for post 10', 40, 0, '1', 2),
(11, 'Post Title 11', 'Recipe description for post 11', 'Post content for post 11', 33, 0, '1', 3),
(12, 'Post Title 12', 'Recipe description for post 12', 'Post content for post 12', 28, 0, '1', 3),
(13, 'Post Title 13', 'Recipe description for post 13', 'Post content for post 13', 17, 0, '1', 3),
(14, 'Post Title 14', 'Recipe description for post 14', 'Post content for post 14', 19, 0, '1', 3),
(15, 'Post Title 15', 'Recipe description for post 15', 'Post content for post 15', 24, 0, '1', 3),
(16, 'Post Title 16', 'Recipe description for post 16', 'Post content for post 16', 38, 0, '1', 4),
(17, 'Post Title 17', 'Recipe description for post 17', 'Post content for post 17', 42, 0, '1', 4),
(18, 'Post Title 18', 'Recipe description for post 18', 'Post content for post 18', 31, 0, '1', 4),
(19, 'Post Title 19', 'Recipe description for post 19', 'Post content for post 19', 27, 0, '1', 4),
(20, 'Post Title 20', 'Recipe description for post 20', 'Post content for post 20', 37, 0, '1', 4),
(21, 'Post Title 21', 'Recipe description for post 21', 'Post content for post 21', 60, 0, '1', 5),
(22, 'Post Title 22', 'Recipe description for post 22', 'Post content for post 22', 45, 0, '1', 5),
(23, 'Post Title 23', 'Recipe description for post 23', 'Post content for post 23', 29, 0, '1', 5),
(24, 'Post Title 24', 'Recipe description for post 24', 'Post content for post 24', 32, 0, '1', 5),
(25, 'Post Title 25', 'Recipe description for post 25', 'Post content for post 25', 36, 0, '1', 5);
...
INSERT INTO `profile` (`Profile_ID`, `Profile_Name`, `Profile_Email`, `Profile_Desc`, `Profile_Password`, `Profile_Image_ID`) VALUES
(1, 'Jimi Hendrix', 'jimi@example.com', 'Legendary guitarist known for his iconic performances.', 'asdf', '1'),
(2, 'Eric Clapton', 'eric@example.com', 'Renowned guitarist with a distinguished career spanning decades.', 'asdf', '1'),
(3, 'Jimmy Page', 'jimmy@example.com', 'Legendary guitarist and founder of Led Zeppelin.', 'asdf', '1'),
(4, 'Slash', 'slash@example.com', 'Iconic guitarist known for his work with Guns N Roses and Velvet Revolver.', 'asdf', '1'),
(5, 'Eddie Van Halen', 'eddie@example.com', 'Innovative guitarist known for his technical prowess and influential style.', 'asdf', '1');
...
--
ALTER TABLE `post_history`
  MODIFY `Post_History_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
